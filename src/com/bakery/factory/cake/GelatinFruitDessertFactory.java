...
import com.bakery.domain.cake.GelatinChocolateDessert;
/*
 ...
 */
public class GelatinFruitDessertFactory implements AbstractBakery {

	@Override
	public BakedFood bake() {

				  return new GelatinChocolateDessert(); 
	}
